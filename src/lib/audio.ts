...
const quarterPulsePattern = definePattern({
  ...
  notesByHand: {
    ...
    R: [
      ...
      N(12, 12, [T(2, 0, 0), T(2, 1, 0), T(2, 2, 0)], 0.74),
      N(24, 12, [T(2, 0, 0), T(2, 1, 0), T(2, 2, 0)], 0.74),
      N(36, 12, [T(2, 0, 0), T(2, 1, 0), T(2, 2, 0)], 0.74),
    ],
    L: [
      N(0, 24, [T(0, 0, -1), T(0, 0, -2)], 0.78),
      N(24, 24, [T(2, 0, -1), T(2, 0, -2)], 0.70),
    ],
  },
});
...
const eighthBassPulsePattern = definePattern({
  ...
  notesByHand: {
    ...
    // * * * * * * * *  
    R: [
      N(0, 12,  [T(0, 1, 0), T(0, 2, 0), T(0, 0, 1)], 0.80),
      N(12, 12, [T(1, 1, 0), T(1, 2, 0), T(1, 0, 1)], 0.66),
      N(24, 12, [T(2, 1, 0), T(2, 2, 0), T(2, 0, 1)], 0.66),
      N(36, 12, [T(3, 1, 0), T(3, 2, 0), T(3, 0, 1)], 0.66),
    ],
    L: [
      N(0, 6, [T(0, 0, -2)], 0.78),
      N(6, 6, [T(0, 0, -1)], 0.62),
...
const imageChordDotsBassPattern = definePattern({
  ...
  notesByHand: {
    ...
    R: [
      N(0, 12, [T(0, 0, 0), T(0, 1, 0), T(0, 2, 0)], 0.80),
      N(12, 12, [T(1, 0, 0), T(1, 1, 0), T(1, 2, 0)], 0.70),
      N(24, 12, [T(2, 0, 0), T(2, 1, 0), T(2, 2, 0)], 0.70),
      N(36, 12, [T(3, 0, 0), T(3, 1, 0), T(3, 2, 0)], 0.70),
    ],
    L: [
      N(0, 18, [T(0, 0, -2),T(0, 0, -1)], 0.80),
      N(18, 6, [T(0, 0, -2),T(0, 0, -1)], 0.66),
      N(24, 18, [T(0, 0, -2),T(0, 0, -1)], 0.76),
      N(42, 6, [T(0, 0, -2),T(0, 0, -1)], 0.66),
    ],
  },
});

/**
 * @brief 画像2（右手2分和音 + 左手上行8分）
 */
const imageHalfChordAscPattern = definePattern({
  id: "manual.imageHalfChordAsc",
  name: "Half Chord Asc",
  nameJa: "2分和音+上行8分",
  notesByHand: {
    // *       *       
    ...
    R: [
      N(0, 24, [T(0, 0, 0), T(0, 1, 0), T(0, 2, 0)], 0.82),
      N(24, 24, [T(2, 0, 0), T(2, 1, 0), T(2, 2, 0)], 0.76),
    ],
    L: [
      N(0, 6, [T(0, 0, -2)], 0.74),
      N(6, 6, [T(0, 1, -2)], 0.67),
...
const imagePhraseAltBassPattern = definePattern({
  ...
  notesByHand: {
    R: [
      N(0,  6, [T(0, 0, 1), T(0, 2, 0)], 0.82),
      N(6,  6, [T(0, 1, 0)], 0.82),
      N(12, 6, [T(1, 2, 0)], 0.70),
      N(18, 6, [T(0, 0, 1), T(0, 2, 0)], 0.66),
      N(24, 6, [T(0, 1, 1), T(0, 0, 1)], 0.82),
      N(30, 6, [T(0, 2, 0)], 0.82),
      N(36, 6, [T(1, 0, 1)], 0.70),
      N(42, 6, [T(0, 1, 1), T(0, 0, 1)], 0.66),
    ],
    L: [
      N(0, 12,  [T(0, 0, -1), T(0, 1, -1), T(0, 2, -1)], 0.80),
      N(12, 12, [T(1, 0, -1), T(1, 1, -1), T(1, 2, -1)], 0.74),
      N(24, 12, [T(2, 0, -1), T(2, 1, -1), T(2, 2, -1)], 0.74),
      N(36, 12, [T(3, 0, -1), T(3, 1, -1), T(3, 2, -1)], 0.74),
    ],
  },
});
...
const imageAccentSyncPattern = definePattern({
  ...
  notesByHand: {
    R: [
      N(0, 12, [T(0, 0, 0), T(0, 1, 0), T(0, 2, 0)], 0.82),
      N(12, 9, [T(1, 0, 0), T(1, 2, 0)], 0.72),
      N(15, 3, [T(1, 1, 0), T(1, 2, 0)], 0.67),
      N(24, 12, [T(2, 0, 0), T(2, 1, 0), T(2, 2, 0)], 0.80),
      N(36, 9, [T(3, 0, 0), T(3, 2, 0)], 0.72),
      N(39, 3, [T(3, 1, 0), T(3, 2, 0)], 0.67),
    ],
    L: [
      N(0, 18, [T(0, 0, -2),T(0, 0, -1)], 0.80),
      N(18, 6, [T(0, 0, -2),T(0, 0, -1)], 0.66),
      N(24, 6, [T(0, 0, -2),T(0, 0, -1)], 0.66),
      N(30, 12,[T(0, 0, -2),T(0, 0, -1)], 0.74),
      N(42, 6, [T(0, 0, -2),T(0, 0, -1)], 0.70),
    ],
  },
});
